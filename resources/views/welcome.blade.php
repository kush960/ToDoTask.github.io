...
@section('content')
  <div class="w-100 h-100 d-flex justify-content-center align-items-center">
        <div class="text-center" style="width: 40%">
           <h1 class="display-2">ToDo Application</h1>
           <h2 class="pt-5">What's next? Add something to the list!</h2>
           <form action="{{route('todo.store')}}" method="POST">
            @csrf
                 ...
                 <div class="input-group mb-3 w-100">  
                   <input type="text" class="form-control form-control-lg" name='title' placeholder="Type here.." aria-label="Recipient's username" area-describedby="button-addon2">
                    <div class="input-group-append">
                       <button class="btn btn-success" type="submit" id="button-addon2">Add to the list</button>
                                        ...
                                        {{-- show the added Tasks --}}
           
           <button class="btn btn-warning"><a href="{{route('show_task')}}">Show All The Tasks</a></button> 
